...
var routes = [
  {
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-FBDP7AF5.js").then((m) => m.HomePageComponent)
      },
      {
        path: "profile",
      ...
      {
        path: "settings",
        loadComponent: () => import("./chunk-Q25TCKA6.js").then((m) => m.SettingsPageComponent)
      },
      {
        path: "tokens-preview",
...
var ToastContainerComponent = class _ToastContainerComponent {
  toastService = inject(ToastService2);
